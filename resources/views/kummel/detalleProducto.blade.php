        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4 col-md-4 col-lg-4">
                    ...
                    {{-- <div class="osahan-slider-item">
                  <img id="imagenProducto" src="{{$detalleProductosVenta->imagen }}" class="img-fluid mx-auto shadow-sm
                    rounded "
            ...
            <div class="col-lg-7 col-sm-7 col-md-7 claseTexto">
                ...
                <div class="p-4 bg-kumel-2 rounded shadow-sm ">
                    ...
                    <p class=" h6 text-kumel-titulo m-0 d-flex align-items-center">
                        Precio Unidad (CLP) : <b
                            class="h6 m-0 text-kumel-bold price">{{ ' ' .  number_format($detalleProductosVenta->precioVenta,0,',','.')}}
                        </b>
                    </p>
                    </br>
                    @if($detalleProductosVenta->stock==0)
