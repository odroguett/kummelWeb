...
<body class="fixed-bottom-padding">
    ...
    <section class="py-4 osahan-main-body">
        ...
        <div class="d-flex align-items-center mb-3">
            <h3 style="text-align: left;" class="text-kumel-titulo ">Frutos Secos</h3>
        </div>
        <div class="pick_today">
            ...
            <div class="row">
                ...
                @if ($value->STOCK <=0) <div class="col-sm-12 col-md-6 col-lg-3">
                    <div class="list-card bg-light h-100 rounded overflow-hidden position-relative border shadow-sm">
